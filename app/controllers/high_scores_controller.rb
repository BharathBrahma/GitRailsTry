class HighScoresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @high_score.save
        format.html { redirect_to(@high_score, :notice => 'HighScore was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @high_score.update_attributes(params[:high_score])
        format.html { redirect_to(@high_score, :notice => 'HighScore was successfully updated.') }
        format.xml  { head :ok }
      else
